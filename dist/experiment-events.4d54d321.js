let e="https://app.ticketmaster.com/discovery/v2/",t="JIZUA78ORWWvAkFITEgp9n4NpYKrXysZ";async function a(){let a=await fetch(e+`events.json?apikey=${t}&size=20&page=1`);return(await a.json())._embedded.events}async function s(a){let s=await fetch(e+`events/${a}.json?apikey=${t}`);return await s.json()}let n=document.querySelector(".cards_list");(async function(){var e;e=await a(),n.innerHTML="",e.forEach(e=>{n.innerHTML+=`
...
//# sourceMappingURL=experiment-events.4d54d321.js.map
